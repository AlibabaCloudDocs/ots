...
-   TBLPROPERTIES
    ...
    -   tablestore.access\_key\_id、tablestore.access\_key\_secret（必填）：更多信息，请参见[访问控制](https://www.alibabacloud.com/help/doc-detail/27296.htm)。

    -   tablestore.sts\_token（可选）：更多信息，请参见[配置用户权限]()。
