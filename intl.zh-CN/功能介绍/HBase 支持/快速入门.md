...
1.  配置项目依赖
    ...
    更多项目依赖配置方法，参见[从 HBase 迁移到表格存储](/intl.zh-CN/功能介绍/HBase 支持/从HBase Client迁移到Tablestore HBase Client.md)。
...
2.  配置文件
    ...
    更多配置参见[从 HBase 迁移到表格存储](/intl.zh-CN/功能介绍/HBase 支持/从HBase Client迁移到Tablestore HBase Client.md)。
