...
-   [Java SDK：精确查询](/intl.zh-CN/SDK 参考/Java SDK/多元索引/精确查询.md)
-   [Go SDK：精确查询](/intl.zh-CN/SDK 参考/Go SDK/多元索引/精确查询.md)
-   [Python SDK：精确查询](/intl.zh-CN/SDK 参考/Python SDK/多元索引/精确查询.md)
-   [Node.js SDK：精确查询](/intl.zh-CN/SDK 参考/Node.js SDK/多元索引/精确查询.md)
-   [.NET SDK：精确查询](/intl.zh-CN/SDK 参考/.NET SDK/多元索引/精确查询.md)
-   [PHP SDK：精确查询](/intl.zh-CN/SDK 参考/PHP SDK/多元索引/精确查询.md)
