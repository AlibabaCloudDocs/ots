...
-   However, you can implement nested queries and queries of other types in a single request. For more information about the nested type, see [Nested](/intl.en-US/Function Introduction/Search Index/Operations/ARRAY and Nested field types.md).
