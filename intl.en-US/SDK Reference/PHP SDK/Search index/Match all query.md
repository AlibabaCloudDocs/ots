...
|query\_type|The query type. To use match query, set this parameter to QueryTypeConst::MATCH\_ALL\_QUERY.|
...
|columns\_to\_get|Specifies whether to return all columns of each matched row. -   If you set return\_type to ColumnReturnTypeConst::RETURN\_SPECIFIED, you can use return\_names to specify the columns to return.
